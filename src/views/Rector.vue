    ...
    <div class="leadership">
        ...
        <div class="leadership-info__wrapper">
            ...
            <div class="leadership-info">
                ...
                <div class="info-row">
                    <div class="info-item">
                        <strong>Qabul vaqtlari:</strong> Juma 14:00 - 17:00
                    </div>
...
.leadership-info__link:hover {
    background: rgba(82, 148, 229, 0.1);
    border-color: rgba(82, 148, 229, 1);
}
...
.leadership-info__social a:hover {
    background: rgba(82, 148, 229, 1);
    color: white;
    border-color: rgba(82, 148, 229, 1);
}
...
/* Reception Block */
.reception-block {
    /* background: linear-gradient(135deg, rgba(82, 148, 229, 0.05), rgba(82, 148, 229, 0.02)); */
    border-color: rgba(82, 148, 229, 0.3);
}
...
.reception-content strong {
    color: rgba(82, 148, 229, 1);
    font-weight: 600;
}

/* Message Block */
.message-block .content p.greeting {
    font-weight: 600;
    color: rgba(22, 35, 71, 1);
    font-size: 16px;
}

.message-block .content p.slogan {
    text-align: center;
    font-size: 18px;
    font-weight: 700;
    color: rgba(82, 148, 229, 1);
    margin-top: 20px;
    padding: 16px;
    background: linear-gradient(135deg, rgba(82, 148, 229, 0.1), rgba(82, 148, 229, 0.05));
    border-radius: 8px;
    border-left: 4px solid rgba(82, 148, 229, 1);
}
