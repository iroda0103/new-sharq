    ...
    <div class="container">
      ...
      <div class="direction-filters">
        <div class="filter-group">
          <label for="faculty-filter">Fakultet bo'yicha filtrlash:</label>
      ...
      directions: [
        {
          ...
          price: "Kunduzgi ta'lim - 18 mln. so'm",
          faculty: "texnika",
          type: "kunduzgi",
          link: "/page/direction-ai",
        },
        {
        ...
        {
          title: "Biznesni boshqarish(tarmoqlar bo‘yicha)",
          icon: "briefcase",
          duration: "4 yil",
          credits: "240 kredit",
          semester: "Kuzgi semestr",
        ...
        {
          title: "Marketing(tarmoqlar va sohalar bo‘yicha)",
          icon: "bullhorn",
          duration: "4 yil",
          credits: "240 kredit",
          semester: "Kuzgi semestr",
...
-->
<!-- <style lang="scss">
/* Yo'nalishlar sahifasi uchun stil */
.directions-page {
  padding: 40px 0;
}
...
//   border-top: 4px solid #00bafc;
//   border-top: 4px solid transparent;
//   border-image: linear-gradient(to right, #00bafc, #0062ff);
...
.direction-header {
  ...
  .direction-icon {
    ...
    // background-color: linear-gradient(to bottom, #00bafc, #0062ff);
    ;
