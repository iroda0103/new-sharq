...
<!-- NewsSection.vue - Asosiy komponent -->
<template>
        ...
        <div class="container">
            ...
            <div class="news-grid">
                <NewsCard 
                    ...
                    :key="news.id" 
                    :news="news"
                    :featured="news.id === featuredNews[0]?.id"
                />
            </div>
        </div>
    </section>
...
// Props (API dan kelgan data uchun)
...
const featuredNews = computed(() => newsData.value.slice(0, props.limit))
</script>
